Attribute VB_Name = "CsvAggregation_RTLS"
Option Explicit

Private Const CSV_ROOT_FOLDER As String = "csv"
Private Const TARGET_TRACK As String = "WFD-RTL_Synthesis"

Private Const SHEET_USERS As String = "RTLS_UserList"
Private Const SHEET_PASSED As String = "RTLS_PassedList"
...
Public Sub SetupRTLSAggregation()
    ...
    MsgBox _
        ...
        "Use the Run RTLS Aggregation button on the first row of the " & _
        SHEET_USERS & " sheet.", _
        vbInformation
...
Public Sub RunRTLSAggregation()
    ...
    If IsEmpty(dateFolders) Then
        MsgBox _
            ...
            "Example: csv\20260806\WFD-RTL_Synthesis\", _
            vbExclamation
        GoTo SafeExit
    End If
...
Private Function GetTargetExamName( _
    ...
    Select Case LCase$(title)
        ...
        Case LCase$("SystemVerilog for RTL Design Exam")
            GetTargetExamName = _
                "SystemVerilog for RTL Design Exam"

        Case LCase$("Design Compiler NXT: RTL Synthesis Exam")
            GetTargetExamName = _
                "Design Compiler NXT: RTL Synthesis Exam"

        Case LCase$("Design Compiler NXT: Low Power Exam")
            GetTargetExamName = _
                "Design Compiler NXT: Low Power Exam"

        Case LCase$("Fusion Compiler: UPF Fundamentals Exam")
            GetTargetExamName = "Fusion Compiler: UPF Fundamentals Exam"
...
Private Sub CreateRunButton(ByVal ws As Worksheet)
    ...
    On Error Resume Next
    ws.Buttons("btnRunRTLSAggregation").Delete
    On Error GoTo 0
    ...
    With btn
        .Name = "btnRunRTLSAggregation"
        .Caption = "Run RTLS Aggregation"
