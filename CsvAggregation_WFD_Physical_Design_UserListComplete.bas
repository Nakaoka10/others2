Attribute VB_Name = "CsvAggregation_PD"
Option Explicit

Private Const CSV_ROOT_FOLDER As String = "csv"
Private Const TARGET_TRACK As String = "WFD-Physical_Design"

Private Const SHEET_USERS As String = "PD_UserList"
Private Const SHEET_PASSED As String = "PD_PassedList"
...
Public Sub SetupPDAggregation()
    ...
    MsgBox _
        ...
        "Use the Run PD Aggregation button on the first row of the " & _
        SHEET_USERS & " sheet.", _
        vbInformation
...
Public Sub RunPDAggregation()
    ...
    If IsEmpty(dateFolders) Then
        MsgBox _
            ...
            "Example: csv\20260806\WFD-Physical_Design\", _
            vbExclamation
        GoTo SafeExit
    End If
...
Private Function GetTargetExamName( _
    ...
    Select Case LCase$(title)
        ...
        Case LCase$("Fusion Compiler: Design Implementation Exam")
            GetTargetExamName = _
                "Fusion Compiler: Design Implementation Exam"

        Case LCase$("Fusion Compiler: Design Creation and Synthesis Exam")
            GetTargetExamName = _
                "Fusion Compiler: Design Creation and Synthesis Exam"
...
Private Sub CreateRunButton(ByVal ws As Worksheet)
    ...
    On Error Resume Next
    ws.Buttons("btnRunPDAggregation").Delete
    On Error GoTo 0
    ...
    With btn
        .Name = "btnRunPDAggregation"
        .Caption = "Run PD Aggregation"
