...
' v4: Preserve leading zeros in Username IDs.
...
Public Sub RunPreviousYearAggregation()
    ...
    ExportTrackWorkbooks trackNames, basePath

    MsgBox "Previous year aggregation completed." & vbCrLf & vbCrLf & _
           "Processed xlsx files: " & processedFileCount & vbCrLf & _
           "Skipped xlsx files: " & skippedFileCount & vbCrLf & _
           "Track workbooks exported: " & (UBound(trackNames) - LBound(trackNames) + 1), vbInformation
...
Private Function ProcessSourceWorkbook(ByVal filePath As String, ByVal courseMap As Object, _
    ...
    For r = 2 To UBound(data, 1)
        ...
        ' Username is an ID. Read displayed text to preserve leading zeros.
        username = CleanText(ws.Cells(r, colUsername).Text)
...
Private Sub OutputUserTrack(ByVal trackName As String, ByVal users As Object, _
    ...
    ' Keep Username as text when writing the aggregate sheet.
...
Private Sub ExportTrackWorkbooks(ByVal trackNames As Variant, ByVal outputFolder As String)
    ...
    For i = LBound(trackNames) To UBound(trackNames)
        trackName = CStr(trackNames(i))
        ExportSingleTrackWorkbook trackName, outputFolder
    Next i

End Sub

Private Sub ExportSingleTrackWorkbook(ByVal trackName As String, ByVal outputFolder As String)
    ...
    ' Remove buttons / controls from the exported xlsx workbook.
...
ExportError:
    ...
    Err.Raise _
        vbObjectError + 513, _
        "ExportSingleTrackWorkbook", _
        "Failed to export " & trackName & ".xlsx"
