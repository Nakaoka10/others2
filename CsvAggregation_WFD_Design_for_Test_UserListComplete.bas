...
Private Const TARGET_TRACK As String = "WFD-Design_for_Test"

Private Const SHEET_USERS As String = "DFT_UserList"
Private Const SHEET_PASSED As String = "DFT_PassedList"
...
Public Sub SetupDFTAggregation()
    ...
    MsgBox _
        ...
        "Use the Run DFT Aggregation button on the first row of the " & _
        SHEET_USERS & " sheet.", _
        vbInformation
...
Public Sub RunDFTAggregation()
    ...
    If IsEmpty(dateFolders) Then
        MsgBox _
            ...
            "Example: csv\20260806\WFD-Design_for_Test\", _
            vbExclamation
        GoTo SafeExit
    End If
...
Private Function GetTargetExamName( _
    ...
    Select Case LCase$(title)
        ...
        Case LCase$("TestMAX ATPG Exam")
            GetTargetExamName = _
                "TestMAX ATPG Exam"

        Case LCase$("Fusion Compiler: DFT Synthesis Exam")
            GetTargetExamName = _
                "Fusion Compiler: DFT Synthesis Exam"

        Case LCase$("TestMAX Advisor Exam")
            GetTargetExamName = _
                "TestMAX Advisor Exam"

        Case LCase$("TestMAX DFT Exam")
            GetTargetExamName = "TestMAX DFT Exam"
...
Private Sub CreateRunButton(ByVal ws As Worksheet)
    ...
    On Error Resume Next
    ws.Buttons("btnRunDFTAggregation").Delete
    On Error GoTo 0
    ...
    With btn
        .Name = "btnRunDFTAggregation"
        .Caption = "Run DFT Aggregation"
