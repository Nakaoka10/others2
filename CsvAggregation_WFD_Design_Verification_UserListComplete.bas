...
Private Const TARGET_TRACK As String = "WFD-Design_Verification"

Private Const SHEET_USERS As String = "DV_UserList"
Private Const SHEET_PASSED As String = "DV_PassedList"
...
Public Sub SetupDVAggregation()
    ...
    MsgBox _
        ...
        "Use the Run DV Aggregation button on the first row of the " & _
        SHEET_USERS & " sheet.", _
        vbInformation
...
Public Sub RunDVAggregation()
    ...
    If IsEmpty(dateFolders) Then
        MsgBox _
            ...
            "Example: csv\20260806\WFD-Design_Verification\", _
            vbExclamation
        GoTo SafeExit
    End If
...
Private Function GetTargetExamName( _
    ...
    Select Case LCase$(title)
        ...
        Case LCase$("SystemVerilog Assertions Exam")
            GetTargetExamName = _
                "SystemVerilog Assertions Exam"

        Case LCase$("SystemVerilog Verification using UVM Exam")
            GetTargetExamName = _
                "SystemVerilog Verification using UVM Exam"

        Case LCase$("SystemVerilog Testbench Exam")
            GetTargetExamName = _
...
Private Sub CreateRunButton(ByVal ws As Worksheet)
    ...
    On Error Resume Next
    ws.Buttons("btnRunDVAggregation").Delete
    On Error GoTo 0
    ...
    With btn
        .Name = "btnRunDVAggregation"
        .Caption = "Run DV Aggregation"
